...
rayisaninja/geminiprochat:latest
```
...
| `API_BASE_URL` | Custom base url for GEMINI API. Click [here](https://github.com/rayisaninja/GeminiProChat?tab=readme-ov-file#solution-for-user-location-is-not-supported-for-the-api-use) to see when to use this. | ❌ |
